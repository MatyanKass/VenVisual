...
function engineConfig(v: Values): FxConfig | null {
    ...
    return {
        ...
        depth: !!v.particle3d,
        depthAmount: Number(v.particleDepth),
        spin: Number(v.particleSpin),
        trail: String(v.cursorTrail),
        trailLength: Number(v.trailLength),
        trailColors: String(v.trailColor),
        trailColor1: String(v.trailColor1 ?? ""),
        trailWidth: Number(v.trailWidth),
        trailFade: Number(v.trailFade),
        ring: !!v.cursorRing,
        ringSize: Number(v.ringSize),
        ringWidth: Number(v.ringWidth),
        ringColor: String(v.ringColor ?? ""),
        ringLag: Number(v.ringLag),
        click: String(v.clickEffect),
        clickIntensity: Number(v.clickIntensity),
        clickColor: String(v.clickColor ?? ""),
        clickCount: Number(v.clickCount),
        sendSize: Number(v.sendEffectSize),
        colors: String(v.fxColors),
        color1: String(v.fxColor1 ?? ""),
        color2: String(v.fxColor2 ?? ""),
...
function widgetConfig(v: Values): WidgetConfig | null {
    ...
    return {
        ...
        clockFormat: String(v.clockFormat ?? "24"),
        timerLabel: v.sessionTimerLabel !== false,
        fontSize: Number(v.widgetFontSize),
        opacity: Number(v.widgetOpacity),
        offset: Number(v.widgetOffset),
        color: String(v.widgetColor ?? "")
    };
}
